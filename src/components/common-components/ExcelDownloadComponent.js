...
export default function ExcelDownloadComponent({ columnHeaders, data }) {
  const excelDownload = () => {
    let table = `
  ...
  return (
    <div className="download-excel-main">
      <a href={excelDownload()} download="OrderList.xls" aria-label="download excel" className="download-excel">
